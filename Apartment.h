...
class Apartment {
 ...
 public:
   ...
   * @param Coordinates std::pair, which the first is the x
  ...
  /**
   * Operator >, apartment is greater than other if it farther
   * from [31.772425, 35.213506]
   * @param other
  ...
  bool operator> (const Apartment &other) const;
  /**
   * Operator ==, Two apartments are identical if their x and y
   * values are the same, to the point of an epsilon = 0.0001
   * @param other
